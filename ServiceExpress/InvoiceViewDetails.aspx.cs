...
namespace ServiceExpress
{
    public partial class InvoiceViewDetails : System.Web.UI.Page
    {
        ...
        private void bindInvoice(string ivNo)
        {
                ...
                for (int i = 0; i < dsIvDetails.Tables[0].Rows.Count; i++)
                {
                    ...
                    lblDONo.Text = dsIvDetails.Tables[0].Rows[i]["deliveryNo"].ToString();
                    lblCreditTerm.Text = dsIvDetails.Tables[0].Rows[i]["creditTerm"].ToString();
                    lblTotalAmt.Text = dsIvDetails.Tables[0].Rows[i]["totalPrice"].ToString();
                    lblGST.Text = dsIvDetails.Tables[0].Rows[i]["gstAmt"].ToString();
                    lblInvoiceDate.Text = dsIvDetails.Tables[0].Rows[i]["invoiceDate"].ToString();
        ...
        protected void btnExportEx_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataColumn col in table.Columns)
            {
                ...
                xlApp.Cells[16, columnIndex + 1].Borders[XlBordersIndex.xlEdgeTop].LineStyle = XlLineStyle.xlDash;
                xlApp.Cells[16, columnIndex + 1].Borders[XlBordersIndex.xlEdgeBottom].LineStyle = XlLineStyle.xlDash;
                xlApp.Cells[16, columnIndex + 1].Borders[XlBordersIndex.xlEdgeLeft].LineStyle = XlLineStyle.xlDash;
                xlApp.Cells[16, columnIndex + 1].Borders[XlBordersIndex.xlEdgeRight].LineStyle = XlLineStyle.xlDash;
            ...
            foreach (DataRow row in table.Rows)
            {
                ...
                foreach (DataColumn col in table.Columns)
                {
                    ...
                    xlApp.Cells[rowIndex + 1, columnIndex + 1].Borders[XlBordersIndex.xlEdgeTop].LineStyle = XlLineStyle.xlDash;
                    xlApp.Cells[rowIndex + 1, columnIndex + 1].Borders[XlBordersIndex.xlEdgeBottom].LineStyle = XlLineStyle.xlDash;
                    xlApp.Cells[rowIndex + 1, columnIndex + 1].Borders[XlBordersIndex.xlEdgeLeft].LineStyle = XlLineStyle.xlDash;
                    xlApp.Cells[rowIndex + 1, columnIndex + 1].Borders[XlBordersIndex.xlEdgeRight].LineStyle = XlLineStyle.xlDash;
            ...
            xlWorkSheet.Cells[10, columnIndex + 1] = lblInvoiceDate.Text; 
            ...
            xlWorkSheet.Cells[rowIndex + 2, columnIndex + 1] = "$" + lblTotalAmt.Text;
            xlWorkSheet.Cells[rowIndex + 3, columnIndex + 1] = "$" + lblGST.Text;
            xlWorkSheet.Cells[rowIndex + 4, columnIndex + 1] = "$" + lblGrandTotal.Text;
            xlWorkSheet.Cells[rowIndex + 4, columnIndex + 1].Borders[XlBordersIndex.xlEdgeTop].LineStyle = XlLineStyle.xlDouble;
            xlWorkSheet.Cells[rowIndex + 4, columnIndex + 1].Borders[XlBordersIndex.xlEdgeBottom].LineStyle = XlLineStyle.xlDouble;


            xlWorkSheet.Cells[9, 2] = lblCustComName.Text;
