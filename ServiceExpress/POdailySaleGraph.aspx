<%@ Page Title="" Language="C#" MasterPageFile="~/SE_BE.Master" AutoEventWireup="true" CodeBehind="POdailySaleGraph.aspx.cs" Inherits="ServiceExpress.POdailySaleGraph" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <h1 style="text-align: center; background-color: #9966FF;">Purchase Order Daily Sales Line Graph</h1>
       <asp:LineChart ID="LineChart2" runat="server" Style="display: none" ChartHeight="450" ChartWidth="800"
    ...
    <asp:Button ID="Button2" runat="server" Height="26px" OnClick="Button2_Click" Text="PDF" Visible="False" Width="56px" />
         <asp:Chart ID="Chart1" runat="server" Style="display: none" DataSourceID="SqlDataSource1">
             <series>
                 <asp:Series ChartType="Line" Name="Series1" XValueMember="Order Date" YValueMembers="Total Price">
                 </asp:Series>
             </series>
             <chartareas>
